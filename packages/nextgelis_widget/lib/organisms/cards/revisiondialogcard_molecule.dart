...
class RevisionDialogCard extends StatelessWidget {
  final Function? onSave, onCancel;
  const RevisionDialogCard({Key? key, this.onSave, this.onCancel}) : super(key: key);
          ...
          child:Column(
            ...
            children: [
              const  BaseContainer(
                ...
                child: Headline3Text('Revisi Titik Sampling', color: Styles.color102235),
              ),
