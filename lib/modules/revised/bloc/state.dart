...
enum RevisedListStatus { loading, success, failure, detail }

class RevisedListState extends Equatable {
  ...
  const RevisedListState({
    this.status = RevisedListStatus.loading,
